...
class QueryGenerator:
    def __init__(self):
        ...
        self.__userRequestQuery = 'select district_name from cast_userrequests_tbl where req_status = 0'
        ...
        self.__districtIdForDistrictNameQuery = 'select district_id from cast_geo_dist_tbl where district_name in (placeholder_tup_district)'
        ...
        self.__insertDataUserRequestTblQuery = """INSERT INTO placeholder_dbtablename 
                                                    (state_name, district_name,email_id,req_status, req_date) 
                                                    VALUES ('placeholder_state_name', 'placeholder_district_name', 'placeholder_email_id', 'placeholder_req_status', 'placeholder_req_date');"""
